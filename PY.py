...
# Parameters
video_file = "D:\AI Stuido code\AI PJ\\video.mp4"
classnames_file = "D:\AI Stuido code\AI PJ\classnames.txt"
weights_file = "D:\AI Stuido code\AI PJ\yolov4-tiny.weights"
config_file = "D:\AI Stuido code\AI PJ\yolov4-tiny.cfg"
conf_threshold = 0.5
nms_threshold = 0.4
detect_class = "person"
frame_width = 1280
...
# Function to return output layers
...
def change_video_source(video, new_source):
    video.release()
    return cv2.VideoCapture(new_source)
...
while True:
    for _ in range(8):  # Đọc 8 frame mỗi lần lặp
    ...
    if key == ord('q'):
        ...
        new_source = input("Enter new video source: ")
        video.release()
        video = change_video_source(video, new_source)
